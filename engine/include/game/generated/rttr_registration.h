...
RTTR_REGISTRATION {
  ...
  rttr::registration::class_<VariantBase>("VariantBase")
      ...
      .property("entity_id",
                &VariantBase::entity_id)(rttr::metadata("NO_SERIALIZE", true));

  rttr::registration::class_<Vector2>("Vector2")
      .constructor<>()(rttr::policy::ctor::as_object)
      .property("x", &Vector2::x)
      .property("y", &Vector2::y)(rttr::metadata("NO_VARIANT", true));

  rttr::registration::class_<Vector3>("Vector3")
      .constructor<>()(rttr::policy::ctor::as_object)
      .property("x", &Vector3::x)
      .property("y", &Vector3::y)
      .property("z", &Vector3::z)(rttr::metadata("NO_VARIANT", true));
  ...
  rttr::registration::class_<Rectangle>("Rectangle")
      ...
      .property("height",
                &Rectangle::height)(rttr::metadata("NO_VARIANT", true));
  ...
  rttr::registration::class_<Color>("Color")
      ...
      .property("g", &Color::g)
      .property("b", &Color::b)
      .property("a", &Color::a)(rttr::metadata("NO_VARIANT", true));
  ...
  rttr::registration::class_<Camera2D>("Camera2D")
      ...
      .property("zoom", &Camera2D::zoom)(rttr::metadata("NO_VARIANT", true));
  ...
  rttr::registration::class_<Texture2D>("Texture2D")
      ...
      .property("format",
                &Texture2D::format)(rttr::metadata("NO_VARIANT", true));

  rttr::registration::class_<Sprite>("Sprite")
      .constructor<>()(rttr::policy::ctor::as_object)
      .constructor<VariantCreateInfo>()(rttr::policy::ctor::as_object)
      .property("path_to_sprite", &Sprite::path_to_sprite)(
          rttr::metadata("SET_CALLBACK", "handle_new_path"))
