...
bool ConfigManager::load_config() {
  std::filesystem::path path =
      ResourceManager::get().get_resource_subdir("config") / config_file;
...
void ConfigManager::clear() { m_config_values.clear(); }

rapidjson::Value ConfigManager::variant_to_json_value(
...
ConfigManager::ConfigValue ConfigManager::json_value_to_variant(
