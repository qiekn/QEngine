...
public:
  Hierarchy(std::vector<EntityDocument> &entities,
...
private:
  ...
  void handle_entity_context_menu(EntityDocument &entity_document,
                                  uint64_t entity_id);
  ...
  void render_float_field(rapidjson::Document &document,
  ...
  void render_string_field(rapidjson::Document &document,
                           rapidjson::Value &value, uint64_t entity_id,
                           const std::string &variant_type,
                           const std::string &key,
                           const std::string &current_path,
  ...
  void render_array_field(rapidjson::Document &document,
                          rapidjson::Value &value, uint64_t entity_id,
                          const std::string &variant_type,
                          const std::string &key,
                          const std::string &current_path,
  ...
  bool check_variant_exists(const EntityDocument &entity_document,
                            const std::string &variant_name);
  void update_recent_variants(std::vector<std::string> &recent_variants,
                              const std::string &variant_name, int max_recent);
  void add_variant_to_entity(EntityDocument &entity_document,
                             VariantDocument &variant_document);

  void add_required_variants_to_entity(EntityDocument &entity_document,
                                       const std::string &variant_type);
