...
void SetEditorTheme() {
    ...
    colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.29f, 0.29f, 0.29f, 1.00f);
    ...
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.40f, 0.40f, 0.40f, 0.30f);
    ...
    colors[ImGuiCol_DragDropTarget] = ImVec4(0.65f, 0.65f, 0.65f, 0.90f);
